...
def replace_logo():
    try:
        ...
        new_b64 = base64.b64encode(open(r'frontend/public/TSE_PACE_Small_v1.png', 'rb').read()).decode('utf-8')
        ...
        with open('app/pdf_generator.py', 'w') as f:
            f.write(text)
        print('Successfully replaced old base64 strings with TSE_PACE_Small_v1.png')
